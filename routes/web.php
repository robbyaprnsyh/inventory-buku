...
// Route Penerbit
Route::get('penerbit', [PenerbitController::class, 'index'])->name('penerbit.index')->middleware('auth');
...
// Route Hobi
Route::get('hobi', [HobiController::class, 'index'])->name('hobi.index')->middleware('auth');
